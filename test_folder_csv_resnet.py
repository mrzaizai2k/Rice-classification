...
model_dir = 'model/2022-11-04/rice_model_resnet_12.h5' # Đường dẫn model
...
file = open('test_path_and_y_resnet.csv', 'w') # Đổi tên chỗ này, tên mới sẽ tạo file mới, tên cũ thì ghi đè
with file:
...
for rice_folder in os.listdir(test_set_dir):
    ...
    for rice_img in os.listdir(rice_folder_dir):
        ...
        file = open('test_path_and_y_resnet.csv', 'a')
        with file:
            writer = csv.writer(file)
