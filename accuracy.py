...
df = pd.read_csv('test_path_and_y.csv') # Đọc file csv chứa y_true và y_predict
...
plt.title('Rice Confusion Matrix', fontsize=20) # Tiêu đề

plt.savefig('Accuracy.png') # Lưu ảnh
plt.show()
