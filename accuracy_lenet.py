...
df = pd.read_csv('test_path_and_y_lenet.csv') # Đọc file csv chứa y_true và y_predict
...
plt.title('Rice Confusion Matrix Lenet', fontsize=20) # Tiêu đề

plt.savefig('Accuracy Lenet.png') # Lưu ảnh
plt.show()
